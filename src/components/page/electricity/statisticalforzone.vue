    ...
    <div>
        <div class="container">
            <div class="handle-box">
                <el-select v-model="qId" placeholder="请选择地区">
                    <el-option
            ...
            <el-divider content-position="left" v-if="resultInfo.name">地区：{{resultInfo.name}}</el-divider>
...
import { queryZoneList } from '@/api/baseInfo'
export default {
