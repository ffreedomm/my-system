    ...
    <div>
        <div class="container">
            <div class="handle-box">
                <el-select v-model="qId" placeholder="请选择设备">
                    <el-option
            ...
            <el-divider content-position="left" v-if="resultInfo.name">设备：{{resultInfo.name}}</el-divider>
